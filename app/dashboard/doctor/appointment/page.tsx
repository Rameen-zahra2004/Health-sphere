...
export default function DoctorAppointmentsPage() {
  ...
  useEffect(() => {
    ...
    socket.on("appointment-created", (data: Appointment) => {
      dispatch(socketAppointmentCreated(data));
    });

    socket.on("appointment-updated", (data: Appointment) => {
      dispatch(socketAppointmentUpdated(data));
    });

    socket.on("appointment-cancelled", (id: string) => {
      dispatch(socketAppointmentCancelled(id));
    });

    socket.on("appointment-completed", (data: Appointment) => {
